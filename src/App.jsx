...
export default function Portfolio() {
	...
	const projects = [
		...
		},
		{
			...
			live: "#",
			github: "https://github.com/iamDeb5/BackEnd-Practice-Projects/tree/main/Perplexity",
		},
	];
			...
			<section className='px-6 md:px-20 py-20 border-t border-white/10'>
				<div className='flex flex-col md:flex-row justify-between items-start md:items-end gap-4'>
					...
					<p className='text-gray-500 text-sm max-w-sm'>
						A curated selection of projects focusing on performance, design
